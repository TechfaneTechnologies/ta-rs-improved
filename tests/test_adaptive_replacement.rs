...
use ta::indicators::{SimpleMovingAverage, StandardDeviation, ExponentialMovingAverage};
use ta::Next;
...
fn test_standard_deviation_with_replacement() {
    ...
    let result1 = sd.next((base_time + Duration::minutes(2) + Duration::seconds(30), 11.5));
